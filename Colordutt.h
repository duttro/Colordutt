/*
  060814 rdutt modified to support Colors Shield cuts and jumpers
  031215 rdutt transferred to new library Colordutt

  Colordutt modified in to - Colordutt Library for Arduino
...
*/
#ifndef _COLORDUTT_H_
#define _COLORDUTT_H_
...
#define ColorduttBitsPerColor 8

#define ColorduttScreenWidth 8
#define ColorduttScreenHeight 8
...
#define SLB_BIT digitalPinToBitMask(A4) //was (A0)
#define LAT_BIT digitalPinToBitMask(A3) //was (A1)
#define SERCLK_BIT digitalPinToBitMask(A5)

#define SDA_BIT digitalPinToBitMask(7)
#define SCL_BIT digitalPinToBitMask(6)
#define SERRST_BIT digitalPinToBitMask(5)
#define PRCLK_BIT digitalPinToBitMask(4)
#define SERDAT_BIT digitalPinToBitMask(3)


#define RST* portOutputRegister(digitalPinToPort(A2))
#define SLB* portOutputRegister(digitalPinToPort(A4)) //was (A2))
#define LAT* portOutputRegister(digitalPinToPort(A3)) //was (A1))
#define SERCLK* portOutputRegister(digitalPinToPort(A5))

#define SDA* portOutputRegister(digitalPinToPort(7))
#define SCL* portOutputRegister(digitalPinToPort(6))
#define SERRST* portOutputRegister(digitalPinToPort(5))
#define PRCLK* portOutputRegister(digitalPinToPort(4))
#define SERDAT* portOutputRegister(digitalPinToPort(3))

// not used #define open_line0	{*portOutputRegister(digitalPinToPort(8))=digitalPinToBitMask(8);}
// not used #define open_line1	{*portOutputRegister(digitalPinToPort(9))=digitalPinToBitMask(9);}
// not used #define open_line2	{*portOutputRegister(digitalPinToPort(10))=digitalPinToBitMask(10);}
// not used #define open_line3	{*portOutputRegister(digitalPinToPort(11))=digitalPinToBitMask(11);}
// not used #define open_line4	{*portOutputRegister(digitalPinToPort(12))=digitalPinToBitMask(12);}
// not used #define open_line5	{*portOutputRegister(digitalPinToPort(13))=digitalPinToBitMask(13);}
// not used #define open_line6	{*portOutputRegister(digitalPinToPort(3))=digitalPinToBitMask(3);}
// not used #define open_line7	{*portOutputRegister(digitalPinToPort(4))=digitalPinToBitMask(4);}
...
#else
#define close_all_lines	{SERRST_BIT_CLR; SERRST_BIT_SET; PRCLK_BIT_SET; PRCLK_BIT_CLR;} //was define close_all_lines	{PORTB&=0b11000000;PORTD&=0b11000000;}
#endif
...
//#define LAT_BIT 0x0F           // was0x02
//#define SLB PORTF // A0 = PF0
//#define SLB_BIT 0x08           // was 0x01
//#define SCL PORTH // D6 = PH3
//#define SCL_BIT 0x08
//#define SDA PORTH // D7 = PH4
//#define SDA_BIT 0x10

// not used #define open_line0	{PORTH=0x20;} // D8 = PH5
// not used #define open_line1	{PORTH=0x40;} // D9 = PH6
// not used #define open_line2	{PORTB=0x10;} // D10 = PB4
// not used #define open_line3	{PORTB=0x20;} // D11 = PB5
// not used #define open_line4	{PORTB=0x40;} // D12 = PB6
// not used #define open_line5	{PORTB=0x80;} // D13 = PB7
// not used #define open_line6	{PORTE=0x20;} // D3 = PE5
// not used #define open_line7	{PORTG=0x20;} // D4 = PG5
// not used #define close_all_lines	{PORTH=0x00;PORTB=0x00;PORTE=0x00;PORTG=0x00;}
...
// added for PCB update
#define SERCLK_BIT_SET SERCLK|=SERCLK_BIT
#define SERCLK_BIT_CLR SERCLK&=~SERCLK_BIT

#define SERDAT_BIT_SET SERDAT|=SERDAT_BIT
#define SERDAT_BIT_CLR SERDAT&=~SERDAT_BIT

#define SERRST_BIT_SET SERRST|=SERRST_BIT
#define SERRST_BIT_CLR SERRST&=~SERRST_BIT

#define PRCLK_BIT_SET PRCLK|=PRCLK_BIT
#define PRCLK_BIT_CLR PRCLK&=~PRCLK_BIT
...
class ColorduttObject {
 public:
  PixelRGB frameBuffer0[ColorduttScreenWidth*ColorduttScreenHeight];
  PixelRGB frameBuffer1[ColorduttScreenWidth*ColorduttScreenHeight];
...
#else
      // initialize these port pins as outputs
      uint8_t lines[] = {A2,A3,A4,A5,3,4,5,6,7};

      for(int i = 0; i < 9;i++){ //13;i++){
  ...
  void _LED_Init()
    {
      ...
      LED_RST_SET;
      LED_Delay(10);
      // set all SR outputs at 0
      SERRST_BIT_CLR;
      LED_Delay(10);
      SERRST_BIT_SET;
      // transfer SR to PR output
      PRCLK_BIT_SET;
      LED_Delay(10);
      PRCLK_BIT_CLR;
      line = 0;
...
extern ColorduttObject Colordutt;
