/*
  Updated on 052414 rdutt modified to support Colors Shield cuts and jumpers
...
#define LAT_BIT digitalPinToBitMask(A4) //was (A1)
#define SLB_BIT digitalPinToBitMask(A3) //was (A0)
...
#define LAT* portOutputRegister(digitalPinToPort(A4)) //was (A1))
#define SLB* portOutputRegister(digitalPinToPort(A3)) //was (A2))
...
#define SERCLK_BIT digitalPinToBitMask(4)
#define SERDAT_BIT digitalPinToBitMask(3)

#define SERRST* portOutputRegister(digitalPinToPort(5))
#define SERCLK* portOutputRegister(digitalPinToPort(4))
...
#define SERCLK_BIT_SET SERCLK_BIT|=SERCLK_BIT
#define SERCLK_BIT_CLR SERCLK_BIT&=~SERCLK_BIT
#define SERDAT_BIT_SET SERDAT_BIT|=SERDAT_BIT
#define SERDAT_BIT_CLR SERDAT_BIT&=~SERDAT_BIT
#define SERRST_BIT_SET SERRST_BIT|=SERRST_BIT
#define SERRST_BIT_CLR SERRST_BIT&=~SERRST_BIT
 ...
 public:
  ...
  void open_line(unsigned char x)
	...
	case 0 ://SERDAT_BIT_SET;
            ...
            //SERCLK_BIT_CLR;
	        break;
	case 1 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 2 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 3 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 4 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 5 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 6 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	case 7 ://SERCLK_BIT_SET;
            //LED_Delay(1);
            //SERCLK_BIT_CLR;
	        break;
	default: 
